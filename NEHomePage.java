...
public class NEHomePage {
	WebDriver driver;
	String baseUrl = "http://cmsdevmerge.ucsd.edu/news-and-events";
	...
	@Test
  	public void Hero_Label() {
		String expectedLabel = "News & Events";
	...
	@Test
  	public void Breadcrumb() {
		String expectedBreadCrumb = "Home  / News & Events";
