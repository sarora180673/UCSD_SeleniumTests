...
public class Cat_Humanities {
	WebDriver driver;
	String baseUrl = "http://cmsdevmerge.ucsd.edu/courses-and-programs/humanities";
	
	@Test
	  public void PageTitle() {
		  String expectedTitle = "Humanities | UCSD Extension";
		  String actualTitle = "";
	...
	@Test
  	public void Hero_Label() {
		String expectedLabel = "Humanities";
	...
	@Test
  	public void Breadcrumb() {
		String expectedBreadCrumb = "Home /  Courses and Programs / Humanities";
	...
	@Test
  	public void CourseList() {
		...
		ExpectedCourse[1] = "Cultural Foods (BIOL-40274)";
  	...
  	public void CourseURL() {
		String CourseURL[] = new String[30];
		 String ExpectedCourseURL[] = new String[30];
			...
			ExpectedCourseURL[1] = "http://cmsdevmerge.ucsd.edu/courses-and-programs/cultural-foods";
