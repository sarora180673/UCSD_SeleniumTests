...
public class Cat_SystemsEngineering {
	WebDriver driver;
	String baseUrl = "http://cmsdevmerge.ucsd.edu/courses-and-programs/systems-engineering";
	
	@Test
	  public void PageTitle() {
		  String expectedTitle = "Systems Engineering | UCSD Extension";
		  String actualTitle = "";
	...
	@Test
  	public void Hero_Label() {
		String expectedLabel = "Systems Engineering";
	...
	@Test
  	public void Breadcrumb() {
		String expectedBreadCrumb = "Home /  Courses and Programs / Systems Engineering";
	...
	@Test
  	public void CertificateList() {
		...
		ExpectedCertificate[1] = "Project Management certificate";
		ExpectedCertificate[2] = "Systems Engineering certificate";
	...
	@Test
  	public void CertificateURL() {
		...
		ExpectedCertificateURL[1] = "http://cmsdevmerge.ucsd.edu/courses-and-programs/project-management";
		ExpectedCertificateURL[1] = "http://cmsdevmerge.ucsd.edu/courses-and-programs/systems-engineering-certificate";
