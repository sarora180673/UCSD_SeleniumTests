...
public class Cat_StudioDecorativeArts {
	WebDriver driver;
	String baseUrl = "http://cmsdevmerge.ucsd.edu/courses-and-programs/studio-and-decorative-arts";
	
	@Test
	  public void PageTitle() {
		  String expectedTitle = "Studio and Decorative Arts | UCSD Extension";
		  String actualTitle = "";
	...
	@Test
  	public void Hero_Label() {
		String expectedLabel = "Studio & Decorative Arts";
	...
	@Test
  	public void Breadcrumb() {
		String expectedBreadCrumb = "Home /  Courses and Programs / Studio & Decorative Arts";
