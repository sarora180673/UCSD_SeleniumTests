...
public class Cat_ProfessionalEngineeringReviewsAdvancedStudies {
	WebDriver driver;
	String baseUrl = "https://extension.ucsd.edu/courses-and-programs/pe-reviews";
	
	@Test
	  public void PageTitle() {
		  String expectedTitle = "Professional Engineering Reviews and Advanced Studies | UCSD Extension";
		  String actualTitle = "";
	...
	@Test
  	public void Hero_Label() {
		String expectedLabel = "Professional Engineering Reviews & Advanced Studies";
	...
	@Test
  	public void Breadcrumb() {
		String expectedBreadCrumb = "Home /  Courses and Programs / Professional Engineering Reviews & Advanced Studies";
	...
	//@Test
  	public void CertificateURL() {
		...
		ExpectedCertificateURL[1] = "https://extension.ucsd.edu/courses-and-programs/advanced-studies-in-regulatory-science";
  	...
  	public void CourseURL() {
		String CourseURL[] = new String[30];
		 String ExpectedCourseURL[] = new String[30];
			...
			ExpectedCourseURL[1] = "https://extension.ucsd.edu/courses-and-programs/in-vitro-diagnostics-product-development";
