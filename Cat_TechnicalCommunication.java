...
public class Cat_TechnicalCommunication {
	WebDriver driver;
	String baseUrl = "http://cmsdevmerge.ucsd.edu/courses-and-programs/technical-communication";
	
	@Test
	  public void PageTitle() {
		  String expectedTitle = "Technical Communication | UCSD Extension";
		  String actualTitle = "";
	...
	@Test
  	public void Hero_Label() {
		String expectedLabel = "Technical Communication";
	...
	@Test
  	public void Breadcrumb() {
		String expectedBreadCrumb = "Home /  Courses and Programs / Technical Communication";
