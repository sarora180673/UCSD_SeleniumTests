...
public class Cat_MedicalCoding {
	WebDriver driver;
	String baseUrl = "http://cmsdevmerge.ucsd.edu/courses-and-programs/medical-coding";
	
	@Test
	  public void PageTitle() {
		  String expectedTitle = "Medical Coding | UCSD Extension";
		  String actualTitle = "";
	...
	@Test
  	public void Hero_Label() {
		String expectedLabel = "Medical Coding";
	...
	@Test
  	public void Breadcrumb() {
		String expectedBreadCrumb = "Home /  Courses and Programs / Medical Coding";
