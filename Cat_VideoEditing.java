...
public class Cat_VideoEditing {
	WebDriver driver;
	String baseUrl = "http://cmsdevmerge.ucsd.edu/courses-and-programs/video-and-editing";
	
	@Test
	  public void PageTitle() {
		  String expectedTitle = "Video and Editing | UCSD Extension";
		  String actualTitle = "";
	...
	@Test
  	public void Hero_Label() {
		String expectedLabel = "Video & Editing";
	...
	@Test
  	public void Breadcrumb() {
		String expectedBreadCrumb = "Home /  Courses and Programs / Video & Editing";
	...
	@Test
  	public void CertificateList() {
		...
		ExpectedCertificate[3] = "Graphic and Web Design certificate";
		ExpectedCertificate[4] = "Graphic Design certificate";
	...
	@Test
  	public void CourseList() {
		...
		ExpectedCourse[1] = "Adobe After Effects I: Introduction to Motion Graphics (ART-40587)";
		ExpectedCourse[2] = "ProTools I: Introduction to Audio Production (ART-40592)";
  	...
  	public void CourseURL() {
		String CourseURL[] = new String[30];
		 String ExpectedCourseURL[] = new String[30];
			...
			ExpectedCourseURL[1] = "http://cmsdevmerge.ucsd.edu/courses-and-programs/adobe-after-effects-i-introduction-to-motion-graphics";
			ExpectedCourseURL[2] = "http://cmsdevmerge.ucsd.edu/courses-and-programs/protools-i-introduction-to-audio-production";
