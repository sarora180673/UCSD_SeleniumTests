...
public class Cat_ProfessionalDevelopment {
	WebDriver driver;
	String baseUrl = "http://cmsdevmerge.ucsd.edu/courses-and-programs/professional-development";
	
	@Test
	  public void PageTitle() {
		  String expectedTitle = "Professional Development | UCSD Extension";
		  String actualTitle = "";
	...
	@Test
  	public void Hero_Label() {
		String expectedLabel = "Professional Development";
	...
	@Test
  	public void Breadcrumb() {
		String expectedBreadCrumb = "Home /  Courses and Programs / Professional Development";
