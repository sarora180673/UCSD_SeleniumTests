...
public class LocationsMapsTransportation {
	WebDriver driver;
	String baseUrl = "http://cmsdevmerge.ucsd.edu/about-extension/locations-maps-and-transportation";
	
	@Test
	  public void PageTitle() {
		  String expectedTitle = "Location, Maps & Transportation | UCSD Extension";
		  String actualTitle = "";
	...
	@Test
  	public void Hero_Label() {
		String expectedLabel = "Locations, Maps & Transportation";
	...
	@Test
  	public void Breadcrumb() {
		String expectedBreadCrumb = "Home /  About Extension / Locations, Maps & Transportation";
