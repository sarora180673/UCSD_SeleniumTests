...
public class Cat_EnvironmentalManagement {
	WebDriver driver;
	String baseUrl = "http://cmsdevmerge.ucsd.edu/courses-and-programs/environmental-management";
	
	@Test
	  public void PageTitle() {
		  String expectedTitle = "Environmental Management | UCSD Extension";
		  String actualTitle = "";
	...
	@Test
  	public void Hero_Label() {
		String expectedLabel = "Environmental Management";
	...
	@Test
  	public void Breadcrumb() {
		String expectedBreadCrumb = "Home /  Courses and Programs / Environmental Management";
	...
	@Test
  	public void CertificateList() {
		...
		ExpectedCertificate[1] = "Sustainability & Behavior Change certificate";
	...
	@Test
  	public void CertificateURL() {
		...
		ExpectedCertificateURL[1] = "http://cmsdevmerge.ucsd.edu/courses-and-programs/sustainability-and-behavior-change";
	...
	@Test
  	public void CourseList() {
		...
		ExpectedCourse[1] = "Behavior Change Capstone Project (ENVR-40007)";
		ExpectedCourse[2] = "Community Engagement (ENVR-40005)";
		ExpectedCourse[3] = "Conservation Psychology (ENVR-40000)";
		ExpectedCourse[4] = "Industrial Stormwater Compliance Workshop (BIOL-80002)";
		ExpectedCourse[5] = "Public Policy Clinic (BIOL-40300)";
		ExpectedCourse[6] = "Water Quality Monitoring (ENVR-40003)";
  	...
  	public void CourseURL() {
		String CourseURL[] = new String[30];
		 String ExpectedCourseURL[] = new String[30];
			...
			ExpectedCourseURL[1] = "http://cmsdevmerge.ucsd.edu/courses-and-programs/behavior-change-capstone-project";
			ExpectedCourseURL[2] = "http://cmsdevmerge.ucsd.edu/courses-and-programs/community-engagement";
			ExpectedCourseURL[3] = "http://cmsdevmerge.ucsd.edu/courses-and-programs/conservation-psychology";
			ExpectedCourseURL[4] = "http://cmsdevmerge.ucsd.edu/courses-and-programs/industrial-stormwater-compliance-workshop";
			ExpectedCourseURL[5] = "http://cmsdevmerge.ucsd.edu/courses-and-programs/public-policy-clinic";
			ExpectedCourseURL[6] = "http://cmsdevmerge.ucsd.edu/courses-and-programs/water-quality-monitoring";
