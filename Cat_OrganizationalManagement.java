...
public class Cat_OrganizationalManagement {
	WebDriver driver;
	String baseUrl = "http://cmsdevmerge.ucsd.edu/courses-and-programs/organizational-management-courses";
	
	@Test
	  public void PageTitle() {
		  String expectedTitle = "Organizational Management Courses | UCSD Extension";
		  String actualTitle = "";
	...
	@Test
  	public void Hero_Label() {
		String expectedLabel = "Organizational Management";
	...
	@Test
  	public void Breadcrumb() {
		String expectedBreadCrumb = "Home /  Courses and Programs / Organizational Management";
