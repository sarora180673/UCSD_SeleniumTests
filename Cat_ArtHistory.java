...
public class Cat_ArtHistory {
	WebDriver driver;
	String baseUrl = "http://cmsdevmerge.ucsd.edu/courses-and-programs/art-history";
	
	@Test
	  public void PageTitle() {
		  String expectedTitle = "Art History | UCSD Extension";
		  String actualTitle = "";
	...
	@Test
  	public void Hero_Label() {
		String expectedLabel = "Art History";
	...
	@Test
  	public void Breadcrumb() {
		String expectedBreadCrumb = "Home /  Courses and Programs / Art History";
	...
	@Test
  	public void CourseList() {
		...
		String ExpectedCourse[] = new String[10];
		
		//ExpectedCourse[1] = "Architectural History of San Diego (ART-40436)";
		ExpectedCourse[1] = "Art of the High Renaissance & the Baroque Age (ART-40450)";
		//ExpectedCourse[3] = "Art of the Late Gothic and Early Renaissance (ART-40444)";
		//ExpectedCourse[4] = "Art of the Medieval World (ART-40434)";
		ExpectedCourse[2] = "Art through the Ages: Rococo to Impressionism (ART-40461)";
  	...
  	public void CourseURL() {
		String CourseURL[] = new String[20];
		 String ExpectedCourseURL[] = new String[20];
			...
			//ExpectedCourseURL[1] = "http://cmsdevmerge.ucsd.edu/courses-and-programs/architectural-history-of-san-diego";
			ExpectedCourseURL[1] = "http://cmsdevmerge.ucsd.edu/courses-and-programs/art-of-the-high-renaissance-and-the-baroque-age";
			//ExpectedCourseURL[3] = "http://cmsdevmerge.ucsd.edu/courses-and-programs/art-of-the-late-gothic-and-early-renaissance";
			//ExpectedCourseURL[4] = "http://cmsdevmerge.ucsd.edu/courses-and-programs/art-of-the-medieval-world";
			ExpectedCourseURL[2] = "http://cmsdevmerge.ucsd.edu/courses-and-programs/art-through-the-ages-rococo-to-impressionism";
