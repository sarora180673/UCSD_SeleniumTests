...
public class Cat_LeadershipDevelopment {
	WebDriver driver;
	String baseUrl = "http://cmsdevmerge.ucsd.edu/courses-and-programs/leadership-development";
	
	@Test
	  public void PageTitle() {
		  String expectedTitle = "Leadership Development | UCSD Extension";
		  String actualTitle = "";
	...
	@Test
  	public void Hero_Label() {
		String expectedLabel = "Leadership Development";
	...
	@Test
  	public void Breadcrumb() {
		String expectedBreadCrumb = "Home /  Courses and Programs / Leadership Development";
