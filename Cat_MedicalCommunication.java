...
public class Cat_MedicalCommunication {
	WebDriver driver;
	String baseUrl = "http://cmsdevmerge.ucsd.edu/courses-and-programs/medical-communication-courses";
	
	@Test
	  public void PageTitle() {
		  String expectedTitle = "Medical Communication Courses | UCSD Extension";
		  String actualTitle = "";
	...
	@Test
  	public void Hero_Label() {
		String expectedLabel = "Medical Communication";
	...
	@Test
  	public void Breadcrumb() {
		String expectedBreadCrumb = "Home /  Courses and Programs / Medical Communication";
