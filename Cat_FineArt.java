...
public class Cat_FineArt {
	
	WebDriver driver;
	String baseUrl = "http://cmsdevmerge.ucsd.edu/courses-and-programs/fine-art";
	
	@Test
	  public void PageTitle() {
		  String expectedTitle = "Fine Art | UCSD Extension";
		  String actualTitle = "";
	...
	@Test
  	public void Breadcrumb() {
		String expectedBreadCrumb = "Home /  Courses and Programs / Fine Art";
	...
	@Test
  	public void CourseList() {
		...
		ExpectedCourse[1] = "Art Programs Information Session (INFO-70157)";
		ExpectedCourse[2] = "Creative Process II (ART-40181)";
		ExpectedCourse[3] = "Drawing I: Focus on Perception (ART-40166)";
		ExpectedCourse[4] = "Drawing Ideas: Developing Your Sketchbook (ART-40447)";
		ExpectedCourse[5] = "Drawing II: Refining Technique (ART-40253)";
		ExpectedCourse[6] = "Figure Drawing I (ART-40006)";
		ExpectedCourse[7] = "Intermediate Watercolor (ART-40239)";
		ExpectedCourse[8] = "Introduction to Painting (ART-40180)";
		ExpectedCourse[9] = "Introduction to Scratchboard (ART-40688)";
  	...
  	public void CourseURL() {
		String CourseURL[] = new String[30];
		 String ExpectedCourseURL[] = new String[30];
			...
			ExpectedCourseURL[1] = "http://cmsdevmerge.ucsd.edu/courses-and-programs/art-programs-information-session";
			ExpectedCourseURL[2] = "http://cmsdevmerge.ucsd.edu/courses-and-programs/creative-process-ii";
			ExpectedCourseURL[3] = "http://cmsdevmerge.ucsd.edu/courses-and-programs/drawing-i-focus-on-perception";
			ExpectedCourseURL[4] = "http://cmsdevmerge.ucsd.edu/courses-and-programs/drawing-ideas-developing-your-sketchbook";
			ExpectedCourseURL[5] = "http://cmsdevmerge.ucsd.edu/courses-and-programs/drawing-ii-refining-technique";
			ExpectedCourseURL[6] = "http://cmsdevmerge.ucsd.edu/courses-and-programs/figure-drawing-i";
			ExpectedCourseURL[7] = "http://cmsdevmerge.ucsd.edu/courses-and-programs/intermediate-watercolor";
			ExpectedCourseURL[8] = "http://cmsdevmerge.ucsd.edu/courses-and-programs/introduction-to-painting";
			ExpectedCourseURL[9] = "http://cmsdevmerge.ucsd.edu/courses-and-programs/introduction-to-scratchboard";
