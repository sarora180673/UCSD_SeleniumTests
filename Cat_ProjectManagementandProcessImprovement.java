...
public class Cat_ProjectManagementandProcessImprovement {
	WebDriver driver;
	String baseUrl = "http://cmsdevmerge.ucsd.edu/courses-and-programs/project-management-courses-san-diego";
	
	@Test
	  public void PageTitle() {
		  String expectedTitle = "Project Management Courses San Diego | UCSD Extension";
		  String actualTitle = "";
	...
	@Test
  	public void Hero_Label() {
		String expectedLabel = "Project Management & Process Improvement";
	...
	@Test
  	public void Breadcrumb() {
		String expectedBreadCrumb = "Home /  Courses and Programs / Project Management & Process Improvement";
