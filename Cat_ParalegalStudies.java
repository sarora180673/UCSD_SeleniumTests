...
public class Cat_ParalegalStudies {
	WebDriver driver;
	String baseUrl = "http://cmsdevmerge.ucsd.edu/courses-and-programs/paralegal-studies";
	
	@Test
	  public void PageTitle() {
		  String expectedTitle = "Paralegal Studies | UCSD Extension";
		  String actualTitle = "";
	...
	@Test
  	public void Hero_Label() {
		String expectedLabel = "Paralegal Studies";
	...
	@Test
  	public void Breadcrumb() {
		String expectedBreadCrumb = "Home /  Courses and Programs / Paralegal Studies";
