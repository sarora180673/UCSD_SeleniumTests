...
public class IntheNews {
	WebDriver driver;
	String baseUrl = "http://cmsdevmerge.ucsd.edu/news-and-events/media-room/in-the-news";
	...
	@Test
  	public void Hero_Label() {
		String expectedLabel = "In the News";
	...
	@Test
  	public void Breadcrumb() {
		String expectedBreadCrumb = "Home /  News & Events / Media Room / In the News";
