...
public class Pgm_Brewing_old {
	public static void main(String[] args) {
        // declaration and instantiation of objects/variables
			...
			String baseUrl = "http://cmsdevmerge.ucsd.edu/courses-and-programs/brewing";
			String expectedTitle = "UCSD Extension DEVMERGE - Brewing";
			String actualTitle = "";
			String expectedBreadCrumb = "Home /  Courses and programs / Brewing";
