...
public class Cat_MobileApplicationsProgrammingDesign {
	WebDriver driver;
	String baseUrl = "http://cmsdevmerge.ucsd.edu/courses-and-programs/mobile-applications";
	
	@Test
	  public void PageTitle() {
		  String expectedTitle = "Mobile Applications Programming and Design | UCSD Extension";
		  String actualTitle = "";
	...
	@Test
  	public void Hero_Label() {
		String expectedLabel = "Mobile Applications Programming & Design";
	...
	@Test
  	public void Breadcrumb() {
		String expectedBreadCrumb = "Home /  Courses and Programs / Mobile Applications Programming & Design";
