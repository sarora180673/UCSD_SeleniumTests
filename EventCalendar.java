...
public class EventCalendar {
	WebDriver driver;
	String baseUrl = "http://cmsdevmerge.ucsd.edu/news-and-events/Event-Calendar";
	...
	@Test
  	public void Hero_Label() {
		String expectedLabel = "Event Calendar";
	...
	@Test
  	public void Breadcrumb() {
		String expectedBreadCrumb = "Home /  News & Events / Event Calendar";
