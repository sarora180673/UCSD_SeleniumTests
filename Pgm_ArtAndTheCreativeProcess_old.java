...
public class Pgm_ArtAndTheCreativeProcess_old {
	public static void main(String[] args) {
        // declaration and instantiation of objects/variables
			...
			String baseUrl = "http://cmsdevmerge.ucsd.edu/courses-and-programs/art-and-the-creative-process";
			String expectedTitle = "UCSD Extension DEVMERGE - Art and the Creative Process";
			String actualTitle = "";
			String expectedBreadCrumb = "Home /  Courses and programs / Art and the Creative Process";
