...
public class Cat_PerformingArts {
	WebDriver driver;
	String baseUrl = "http://cmsdevmerge.ucsd.edu/courses-and-programs/performing-arts";
	
	@Test
	  public void PageTitle() {
		  String expectedTitle = "Performing Arts | UCSD Extension";
		  String actualTitle = "";
	...
	@Test
  	public void Hero_Label() {
		String expectedLabel = "Performing Arts";
	...
	@Test
  	public void Breadcrumb() {
		String expectedBreadCrumb = "Home /  Courses and Programs / Performing Arts";
