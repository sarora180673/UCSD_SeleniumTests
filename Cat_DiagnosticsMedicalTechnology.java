...
public class Cat_DiagnosticsMedicalTechnology {
	WebDriver driver;
	String baseUrl = "http://cmsdevmerge.ucsd.edu/courses-and-programs/diagnostics-and-medical-technology";
	
	@Test
	  public void PageTitle() {
		  String expectedTitle = "Diagnostics and Medical Technology | UCSD Extension";
		  String actualTitle = "";
	...
	@Test
  	public void Hero_Label() {
		String expectedLabel = "Diagnostics and Medical Technology";
	...
	@Test
  	public void Breadcrumb() {
		String expectedBreadCrumb = "Home /  Courses and Programs / Diagnostics and Medical Technology";
	...
	@Test
  	public void CertificateList() {
		...
		ExpectedCertificate[3] = "In Vitro Diagnostics certificate";
	...
	@Test
  	public void CertificateURL() {
		...
		ExpectedCertificateURL[3] = "http://cmsdevmerge.ucsd.edu/courses-and-programs/in-vitro-diagnostics";
