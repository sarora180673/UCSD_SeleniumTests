...
public class Cat_DataStorageManagement {
	WebDriver driver;
	String baseUrl = "http://cmsdevmerge.ucsd.edu/courses-and-programs/data-storage-and-management";
	
	@Test
	  public void PageTitle() {
		  String expectedTitle = "Data Storage and Management Courses | UCSD Extension";
		  String actualTitle = "";
	...
	@Test
  	public void Hero_Label() {
		String expectedLabel = "Data Storage and Management";
	...
	@Test
  	public void Breadcrumb() {
		String expectedBreadCrumb = "Home /  Courses and Programs / Data Storage and Management";
	...
	@Test
  	public void CertificateList() {
		...
		ExpectedCertificate[1] = "Database Administration using Oracle certificate";
