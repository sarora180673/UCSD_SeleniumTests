...
public class MediaRoom {
	WebDriver driver;
	String baseUrl = "http://cmsdevmerge.ucsd.edu/news-and-events/media-room";
	...
	@Test
  	public void Hero_Label() {
		String expectedLabel = "Media Room";
	...
	@Test
  	public void Breadcrumb() {
		String expectedBreadCrumb = "Home /  News & Events / Media Room";
