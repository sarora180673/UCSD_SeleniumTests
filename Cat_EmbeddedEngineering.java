...
public class Cat_EmbeddedEngineering {
	WebDriver driver;
	String baseUrl = "http://cmsdevmerge.ucsd.edu/courses-and-programs/embedded-engineering";
	
	@Test
	  public void PageTitle() {
		  String expectedTitle = "Embedded Engineering | UCSD Extension";
		  String actualTitle = "";
	...
	@Test
  	public void Hero_Label() {
		String expectedLabel = "Embedded Engineering";
	...
	@Test
  	public void Breadcrumb() {
		String expectedBreadCrumb = "Home /  Courses and Programs / Embedded Engineering";
	...
	@Test
  	public void CertificateList() {
		...
		ExpectedCertificate[1] = "Embedded Computer Engineering certificate";
		ExpectedCertificate[2] = "Embedded Computer Software certificate";
	...
	@Test
  	public void CertificateURL() {
		...
		ExpectedCertificateURL[1] = "http://cmsdevmerge.ucsd.edu/courses-and-programs/embedded-computer-engineering";
		ExpectedCertificateURL[2] = "http://cmsdevmerge.ucsd.edu/courses-and-programs/embedded-computer-software";
	...
	@Test
  	public void CourseList() {
		...
		ExpectedCourse[1] = "Embedded Controller Hardware Design (ECE-40001)";
		ExpectedCourse[2] = "Embedded Controller Programming I: Introduction (ECE-40084)";
		ExpectedCourse[3] = "Embedded Controller Programming III: Real-Time Programming (ECE-40097)";
		ExpectedCourse[4] = "Embedded Linux (ECE-40105)";
		ExpectedCourse[5] = "Embedded RTOS (ECE-40089)";
		ExpectedCourse[6] = "FPGA Embedded Design (ECE-40260)";
  	...
  	public void CourseURL() {
		String CourseURL[] = new String[30];
		 String ExpectedCourseURL[] = new String[30];
			...
			ExpectedCourseURL[1] = "http://cmsdevmerge.ucsd.edu/courses-and-programs/embedded-controller-hardware-design";
			ExpectedCourseURL[2] = "http://cmsdevmerge.ucsd.edu/courses-and-programs/embedded-controller-programming-i-introduction";
			ExpectedCourseURL[3] = "http://cmsdevmerge.ucsd.edu/courses-and-programs/embedded-controller-programming-iii-real-time-programming";
			ExpectedCourseURL[4] = "http://cmsdevmerge.ucsd.edu/courses-and-programs/embedded-linux";
			ExpectedCourseURL[5] = "http://cmsdevmerge.ucsd.edu/courses-and-programs/embedded-rtos";
			ExpectedCourseURL[6] = "http://cmsdevmerge.ucsd.edu/courses-and-programs/fpga-embedded-design";
