...
public class Cat_Photography {
	WebDriver driver;
	String baseUrl = "http://cmsdevmerge.ucsd.edu/courses-and-programs/photography";
	
	@Test
	  public void PageTitle() {
		  String expectedTitle = "Photography | UCSD Extension";
		  String actualTitle = "";
	...
	@Test
  	public void Hero_Label() {
		String expectedLabel = "Photography";
	...
	@Test
  	public void Breadcrumb() {
		String expectedBreadCrumb = "Home /  Courses and Programs / Photography";
