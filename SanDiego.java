...
public class SanDiego {
	WebDriver driver;
	String baseUrl = "http://cmsdevmerge.ucsd.edu/about-extension/san-diego";
	
	@Test
	  public void PageTitle() {
		  String expectedTitle = "San Diego Science & Technology Destination | UCSD Extension";
		  String actualTitle = "";
	...
	@Test
  	public void Hero_Label() {
		String expectedLabel = "San Diego";
	...
	@Test
  	public void Breadcrumb() {
		String expectedBreadCrumb = "Home /  About Extension / San Diego";
