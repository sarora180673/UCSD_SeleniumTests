...
public class Cat_PharmaceuticalOperations {
	WebDriver driver;
	String baseUrl = "http://cmsstaging.ucsd.edu/courses-and-programs/pharmaceutical-operations";
	
	@Test
	  public void PageTitle() {
		  String expectedTitle = "Pharmaceutical Operations | UCSD Extension";
		  String actualTitle = "";
	...
	@Test
  	public void Hero_Label() {
		String expectedLabel = "Pharmaceutical Operations";
	...
	@Test
  	public void Breadcrumb() {
		String expectedBreadCrumb = "Home /  Courses and Programs / Pharmaceutical Operations";
	...
	@Test
  	public void CourseList() {
		...
		ExpectedCourse[1] = "Advanced QA/QC for Drugs & Biologics (BIOL-40021)";
		ExpectedCourse[2] = "Careers in Project Management (INFO-70061)";
		ExpectedCourse[3] = "Good Documentation Practices (BIOL-40201)";
		ExpectedCourse[4] = "Good Manufacturing Practices (BIOL-40000)";
  	...
  	public void CourseURL() {
		String CourseURL[] = new String[30];
		 String ExpectedCourseURL[] = new String[30];
			...
			ExpectedCourseURL[1] = "http://cmsstaging.ucsd.edu/courses-and-programs/advanced-qa-qc-for-drugs-and-biologics";
			ExpectedCourseURL[2] = "http://cmsstaging.ucsd.edu/courses-and-programs/careers-in-project-management";
			ExpectedCourseURL[3] = "http://cmsstaging.ucsd.edu/courses-and-programs/good-documentation-practices";
			ExpectedCourseURL[4] = "http://cmsstaging.ucsd.edu/courses-and-programs/good-manufacturing-practices";
