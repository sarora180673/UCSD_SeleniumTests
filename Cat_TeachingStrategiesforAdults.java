...
public class Cat_TeachingStrategiesforAdults {
	WebDriver driver;
	String baseUrl = "http://cmsdevmerge.ucsd.edu/courses-and-programs/teaching-strategies-for-adults";
	
	@Test
	  public void PageTitle() {
		  String expectedTitle = "Teaching Strategies for Adults | UCSD Extension";
		  String actualTitle = "";
	...
	@Test
  	public void Hero_Label() {
		String expectedLabel = "Teaching Strategies for Adults";
	...
	@Test
  	public void Breadcrumb() {
		String expectedBreadCrumb = "Home /  Courses and Programs / Teaching Strategies for Adults";
