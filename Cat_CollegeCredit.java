...
public class Cat_CollegeCredit {
	WebDriver driver;
	String baseUrl = "http://cmsdevmerge.ucsd.edu/courses-and-programs/college-credit";
	
	@Test
	  public void PageTitle() {
		  String expectedTitle = "College Credit | UCSD Extension";
		  String actualTitle = "";
	...
	@Test
  	public void Hero_Label() {
		String expectedLabel = "College Credit";
	...
	@Test
  	public void Breadcrumb() {
		String expectedBreadCrumb = "Home /  Courses and Programs / College Credit";
